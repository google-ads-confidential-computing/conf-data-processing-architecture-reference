...
DEFINE_ERROR_CODE(SC_CURL_CLIENT_REQUEST_TIMEOUT, SC_CURL_CLIENT, 0x000B,
                  "HTTP server returned REQUEST_TIMEOUT",
...
DEFINE_ERROR_CODE(SC_CURL_CLIENT_REQUEST_BAD_GATEWAY, SC_CURL_CLIENT, 0x0021,
                  "HTTP server returned BAD_GATEWAY",
