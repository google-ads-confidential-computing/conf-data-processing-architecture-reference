...
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_INVALID_URI, SC_CPIO_INVALID_ARGUMENT)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_FAILED_TO_CONNECT,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_FAILED_TO_ISSUE_HTTP_REQUEST,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_NOT_OK_RESPONSE,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_AUTH_NO_HEADER_SPECIFIED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_AUTH_MISSING_HEADER,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_AUTH_BAD_REQUEST,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_AUTH_ALREADY_SIGNED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_TLS_CTX_ERROR, SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_NO_CONNECTION_ESTABLISHED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_METHOD_NOT_SUPPORTED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_NOT_OK_RESPONSE_BUT_RETRIABLE,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_CONNECTION_POOL_IS_NOT_AVAILABLE,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_CONNECTION_INITIALIZATION_FAILED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_CONNECTION_STOP_FAILED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_CONNECTION_DROPPED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_MULTIPLE_CHOICES,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_MOVED_PERMANENTLY,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_FOUND,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_SEE_OTHER,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_NOT_MODIFIED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_TEMPORARY_REDIRECT,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_PERMANENT_REDIRECT,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_BAD_REQUEST,
                         SC_CPIO_INVALID_ARGUMENT)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_UNAUTHORIZED,
                         SC_CPIO_INVALID_CREDENTIALS)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_FORBIDDEN,
                         SC_CPIO_INVALID_CREDENTIALS)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_NOT_FOUND,
                         SC_CPIO_ENTITY_NOT_FOUND)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_METHOD_NOT_ALLOWED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_REQUEST_TIMEOUT,
                         SC_CPIO_REQUEST_TIMEOUT)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_CONFLICT,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_GONE,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_LENGTH_REQUIRED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_PRECONDITION_FAILED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_REQUEST_ENTITY_TOO_LARGE,
                         SC_CPIO_REQUEST_TOO_LARGE)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_REQUEST_URI_TOO_LONG,
                         SC_CPIO_REQUEST_TOO_LARGE)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_UNSUPPORTED_MEDIA_TYPE,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(
    SC_HTTP2_CLIENT_HTTP_STATUS_REQUEST_RANGE_NOT_SATISFIABLE,
    SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_TOO_MANY_REQUESTS,
                         SC_CPIO_REQUEST_LIMIT_REACHED)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_INTERNAL_SERVER_ERROR,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_NOT_IMPLEMENTED,
                         SC_CPIO_NOT_IMPLEMENTED)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_BAD_GATEWAY,
                         SC_CPIO_SERVICE_UNAVAILABLE)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_SERVICE_UNAVAILABLE,
                         SC_CPIO_SERVICE_UNAVAILABLE)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_GATEWAY_TIMEOUT,
                         SC_CPIO_SERVICE_UNAVAILABLE)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_STATUS_HTTP_VERSION_NOT_SUPPORTED,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_REQUEST_CLOSE_ERROR,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_REQUEST_RESPONSE_STATUS_UNKNOWN,
                         SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_HTTP2_CLIENT_HTTP_CONNECTION_NOT_READY,
                         SC_CPIO_INTERNAL_ERROR)
}  // namespace google::scp::core::errors
