...
DEFINE_ERROR_CODE(SC_PRIVATE_KEY_CLIENT_PROVIDER_INVALID_REQUEST,
                  SC_PRIVATE_KEY_CLIENT_PROVIDER, 0x0009,
                  "Invalid request for listing private keys",
...
MAP_TO_PUBLIC_ERROR_CODE(
    ...
    SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_PRIVATE_KEY_CLIENT_PROVIDER_INVALID_REQUEST,
                         SC_CPIO_INVALID_ARGUMENT)
}  // namespace google::scp::core::errors
