...
DEFINE_ERROR_CODE(SC_PRIVATE_KEY_FETCHER_PROVIDER_ACTIVATION_TIME_NOT_FOUND,
                  SC_PRIVATE_KEY_FETCHER_PROVIDER, 0x000F,
                  "Cannot find the activation time", HttpStatusCode::NOT_FOUND)
