...
DEFINE_ERROR_CODE(SC_PUBLIC_KEY_CLIENT_PROVIDER_INVALID_REQUEST,
                  SC_PUBLIC_KEY_CLIENT_PROVIDER, 0x0006,
                  "Invalid request for list public keys",
                  HttpStatusCode::BAD_REQUEST)
...
MAP_TO_PUBLIC_ERROR_CODE(
    SC_PUBLIC_KEY_CLIENT_PROVIDER_ALL_URIS_REQUEST_PERFORM_FAILED,
    SC_CPIO_INVALID_ARGUMENT)
MAP_TO_PUBLIC_ERROR_CODE(SC_PUBLIC_KEY_CLIENT_PROVIDER_INVALID_REQUEST,
                         SC_CPIO_INVALID_ARGUMENT)
}  // namespace google::scp::core::errors
