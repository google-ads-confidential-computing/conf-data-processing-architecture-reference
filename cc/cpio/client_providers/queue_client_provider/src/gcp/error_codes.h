...
DEFINE_ERROR_CODE(SC_GCP_QUEUE_CLIENT_PROVIDER_CLOUD_UNAVAILABLE,
                  SC_GCP_QUEUE_CLIENT_PROVIDER, 0x000C,
                  "Cloud PubSub in unavailable",
...
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_QUEUE_CLIENT_PROVIDER_CLOUD_UNAVAILABLE,
