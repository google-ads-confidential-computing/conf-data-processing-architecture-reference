...
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_INTERNAL_SERVICE_ERROR, SC_CPIO_INTERNAL_ERROR)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_NOT_FOUND, SC_CPIO_ENTITY_NOT_FOUND)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_INVALID_ARGUMENT, SC_CPIO_INVALID_ARGUMENT)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_DEADLINE_EXCEEDED, SC_CPIO_REQUEST_TIMEOUT)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_UNAUTHENTICATED, SC_CPIO_INVALID_CREDENTIALS)
...
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_PERMISSION_DENIED, SC_CPIO_INVALID_CREDENTIALS)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_RESOURCE_EXHAUSTED,
                         SC_CPIO_REQUEST_LIMIT_REACHED)
MAP_TO_PUBLIC_ERROR_CODE(SC_GCP_FAILED_PRECONDITION, SC_CPIO_INTERNAL_ERROR)
