...
build_command="bazel build --//cc/public/cpio/interface:platform=gcp --//cc/public/cpio/interface:run_inside_tee=True cc/cpio/worker/native_lib/deploy/gcp:lib_cmrt_worker_gcp_postsubmit_test"
