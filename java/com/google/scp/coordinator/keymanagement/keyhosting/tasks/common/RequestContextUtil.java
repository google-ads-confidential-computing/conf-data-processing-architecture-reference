...
package com.google.scp.coordinator.keymanagement.keyhosting.tasks.common;
...
public class RequestContextUtil {
  ...
  public static long getPositiveNumberRequestValue(RequestContext request, String param)
      throws ServiceException {
    String paramString = getRequestParameter(request, param);
    try {
      long value = Long.parseLong(paramString);
      if (value < 0) {
        throw new ServiceException(
            Code.INVALID_ARGUMENT,
            SharedErrorReason.INVALID_ARGUMENT.name(),
            String.format("%s should be positive, found (%s) instead.", param, value));
      }
      return value;
      ...
      throw new ServiceException(
          Code.INVALID_ARGUMENT,
          SharedErrorReason.INVALID_ARGUMENT.name(),
          String.format("%s should be a valid number, found %s.", param, paramString),
          e);
    }
  }
}
