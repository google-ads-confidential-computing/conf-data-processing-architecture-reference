...
import com.google.scp.operator.worker.writer.avro.LocalAvroResultFileWriter;

/**
 * Module that uses the {@code LocalFileToCloudStorageLogger}, {@code LocalAvroResultFileWriter},
 * and {@code SinglePartAwsS3Writer}
 */
public final class LocalToCloudLoggerModule extends ResultLoggerModule {
  ...
  public void configureModule() {
    bind(LocalResultFileWriter.class).to(LocalAvroResultFileWriter.class);
  }
}
