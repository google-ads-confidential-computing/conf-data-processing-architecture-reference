...
package com.google.scp.operator.worker.perf;
...
/** Registry for named stopwatches to measure performance. */
public final class StopwatchRegistry {
  ...
  /** Empty the stopwatch registry. */
  public void cleanupStopwatches() {
    registry.clear();
  }
